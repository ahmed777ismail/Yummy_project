...
$(".nav-menu-logo").click(function () {
  isTrue
    ? ($(".nav-menu").addClass("open-menu").removeClass("close-menu"),
      (nvWidth = $(".nav-menu").width() - 10),
      $(".strip-nav").css("left", nvWidth),
      $(".fa-align-justify").toggleClass("fa-xmark"),
      $(".nav-menu .item1").animate(
        {
          opacity: "1",
          paddingTop: "25px",
        },
  ...
  for (var i = 0; i < arr.length; i++)
    ...
    <div class=" col-lg-3 my-3 myM  shadow">
        <div onclick="getMainIngredient('${
          arr[i].strIngredient
        }')" class="sections shadow rounded position-relative">
            <div class="post ">
